...
export const PHASES_DATA: Phase[] = [
  {
    ...
    tasks: [
      { 
        id: "1.1", 
        text: "獲知疑似事件 (申請調查或檢舉)", 
        note: " 性平法§22-1/防治準則§16-1：任何人知悉應立即通報學校權責人員。", 
        unit: "學務處" 
      },
      { 
        id: "1.2", 
      ...
      { 
        ...
        note: "性平法§25-1提供「權益告知書」，包含：心理輔導、法律諮詢、救濟管道等相關資訊。", 
        unit: "" 
      },
      { 
        id: "1.4", 
        text: "啟動提供必要之協助服務", 
        note: "防治準則§26/性平法§23-1：\n1. 協助範圍：依需求提供身心輔導、課務調整、不當訊問保護。\n2. 緊急處理：必要時進行緊急隔離 (如調整班級/座位)，事後須送性平會追認。", 
        unit: "" 
      },
    ]
  },
  {
    ...
    tasks: [
      ...
      { 
        id: "2.4", 
        text: "書面通知當事人 (是否受理決定)", 
        note: "性平法§32-1：\n1. 通知時效：收件後 20 日內。\n2. 通知形式：書面通知。\n3. 應告知事項：是否受理；若為「不受理」應詳細敘明理由，並一併教示申復權利（20日內提出）。", 
        unit: "學務處" 
      }
    ]
  },
  {
    ...
    tasks: [
      ...
      { 
        id: "3.7", 
        text: "撰寫調查報告", 
        note: "1. 性平法§36-1: 應於受理後2個月內完成調查. 必要時得延長1個月，可延長兩次(需書面通知當事人)。\n2. 性平法施行細則§17：應包含事實認定及理由、處理建議。", 
        unit: "調查小組",
  ...
  },
  {
    ...
    tasks: [
      { 
        ...
        note: "(防治準則§30-6：通知被害人/家長： 7日內陳述意見。\n性平法§26-5：通知行為人：若懲處涉及「身分改變」(解聘/免職/退學)，應給予7日內書面陳述意見機會", 
        unit: "權責機關 (如教評會/獎懲會)", 
        important: true
      },
      { 
  ...
  },
  {
    ...
    tasks: [
      ...
      { 
        id: "7.4", 
        text: "辦理相關經費核銷", 
        note: "向教育處申請經費(檢附檢核表、調查報告、議決最終調查報告的會議紀錄&簽到表)後辦理經費核銷（如委員交通費、出席費、稿費、餐費等）。", 
        unit: "學務處/總務處" 
      },
    ]
  }
